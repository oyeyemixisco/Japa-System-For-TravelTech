  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="../admin/logout.php" >Lfog out</a></li>
        ...
        <div class="row gy-4" data-aos="fade-up">
          ...
          <div class="col-lg-8">
            <div class="content ps-lg-5">
              ...
              <p>
                Welcome <?php echo $name; ?> to the relocate now members area. If you are here now, it means you've taken the right steps in the right direction towards your journey to relocating out of your present country. In the next few paragraphs below, we will be sharing with you all you have to do in order to complete the process.
                <br><br>
