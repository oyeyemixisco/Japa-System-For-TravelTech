...
$allData = mysqli_query($conn, "SELECT * FROM relc_reg WHERE status='PENDING' ");
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li class="active"><i class="fa fa-warning (alias)"></i><a href="#"> Pending Users</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
                        ...
                        <div class="card text-white bg-flat-color-2">
                            <div class="card-body">
                                <div class="card-left pt-1 float-left">
                                    <h3 class="mb-0 fw-r">
                                        <span class="count"><?php echo $totalPend ?></span>
                                    </h3>
                                    <p class="text-light mt-1 m-0">Pending Users</p>
                                </div>
                                <!-- /.card-left -->
                ...
                <div class="orders">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Pending Users </h4>                                    
                                </div>
