...
// Retrieve the user details based on the ID passed in the URL parameter
$id = $_GET['id'];


$result = mysqli_query($conn, "SELECT * FROM relc_reg WHERE id = $id");
            ...
            <div class="animated">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <strong class="card-title" v-if="headerText">Full User Details</strong>
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Phone Number:</strong> <?php echo $row['mobile']; ?></p>
                        <p><strong>Address:</strong> <?php echo $row['address']; ?></p>
                        <p><strong>Country:</strong> <?php echo $row['country']; ?></p>
                        <p><strong>Education:</strong> <?php echo $row['education']; ?></p>
                        <p><strong>Work Experience:</strong> <?php echo $row['work_experience']; ?></p>
                        <p><strong>Relocation Path:</strong> <?php echo $row['relocation_path']; ?></p>
                        <p><strong>Registration Date:</strong> <?php echo $row['reg_date']; ?></p>
