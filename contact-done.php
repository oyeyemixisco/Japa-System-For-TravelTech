...
<head>
  ...
  <title>Contact Us | RelocateNow</title>
...
<body class="page-contact">
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbsc d-flex align-items-center" style="background-image: url('assets/img/bg9.png');">
      <div class="container position-relative d-flex flex-column align-items-center">

        <h2 class="startz3">Get in Touch</h2>
        <ol>
          <li><a href="index.php">Home</a></li>
          <li>Contact Us</li>
        </ol>
    ...
    <section id="contact" class="contact">
      <div class="container position-relative" data-aos="fade-up">
        <h2 class="startz3">Questions, comments or inquiries?</h2>
        <p> We want to hear from you. Our call lines are availble 24/7, and can take any questions you may have. If you would also like to visit our physical offices, we have 3 offices in Nigeria, located in Lagos, Abuja and Benin.</p>
        <br>
        ...
        <div class="row gy-4 d-flex justify-content-end">
          ...
          <div class="col-lg-5" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="info-item d-flex">
              ...
              <div>
                <h4>Location:</h4>
                <p>3rd Floor, Lennox Mall, Admiralty way, Lekki Phase 1, Lagos</p>
              </div>
            </div><!-- End Info Item -->
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="250">
            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              ...
              <div class="text-center"><button type="submit" class="startzc">Send Message</button></div>
            </form>
