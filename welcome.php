...
<head>
  ...
  <title>Welcome | RelocateNow</title>
...
<body class="page-about">
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbsw d-flex align-items-center" style="//background-image: url('assets/img/aboutbg2.jpg'); background: #eeeeee;">
      <div class="container position-relative d-flex flex-column align-items-center">

        <h2 class="startz3">Welcome, Osasenaga</h2>
        <!-- <ol>
        ...
        <div class="row gy-4" data-aos="fade-up">
          ...
          <div class="col-lg-8">
            <div class="content ps-lg-5">
              <h3 class="startabout" style="font-family: 'Big Shoulders Text', sans-serif;">You are here</h3>
              <p>
                Welcome Osasenaga to the relocate now members area. If you are here now, it means you've taken the right steps in the right direction towards your journey to relocating out of your present country. In the next few paragraphs below, we will be sharing with you all you have to do in order to complete the process.
                <br><br>
                However, we need you to note that your registration was successfully approved because you have the basic requirements in order to proceed to this point. However, this doesn't mean you are automatically guaranteed a place yet. Kinly read on so you uderstand why it is important for you to complete this process.
              </p>

              <h3 style="font-family: 'Big Shoulders Text', sans-serif;">What is this all about?</h3>
              <p>
                RelocateNow.ng is a tech platform which will guide you on EXACTLY the steps you have to follow in order to complete your relocation journey successfully. RelocateNow.ng is a service platform of TravelNow Logistics Ltd, a travel tech provider which has been existing for over 7 years now. We currently host about 1,800 people and growing, on this platfform. All serious people
                <br><br>
                This platform was set up to fulfill ONE need specifically; to help you relocate to a better life at the lowest means possible and using the most guaranteed methods which are currently working. One of the most interesting facts here is we have used these methods for other customers, and some of us too, successfully.
                <br><br>
                We understand it may be difficult reading through too much text, and so we'll try and end limit it here. In summary, you have to complete the process in the next steps below and see what wel
              </p>
              ...
              <p>
                ...
                <li><i class="bi bi-check2-circle"></i> All this and more for only N9,999.</li>
              </ul>
              </p>
              ...
              <!-- <div class="alert alert-success" role="alert">
                ...
                <p>
                Kindly note that our current fee of N9,999 is an introductory fee and will be ending by month end. Our non promo fee is N24,500. Over 1,800 members of this platform can not be wrong. It means you're in good hands. Kindly use the button below to complete your payment via online card or bank transfer payment.</p>
