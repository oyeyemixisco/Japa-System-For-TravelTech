...
<body class="page-about">
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/bg5.jpg');">
      <div class="container position-relative d-flex flex-column align-items-center">

        <h2 class="startz3">Your Relocation Plan Begins Here</h2>
        <ol>
          <li><a href="index.php">Home</a></li>
          <li>Get Started</li>
        </ol>
        ...
        <div class="row gy-4" data-aos="fade-up">
          ...
          <div class="col-lg-8">
            <div class="content ps-lg-5">
              ...
              <p>
                Enter email and password below to login to your account 
              </p>
              <div class="alert alert-danger" role="alert">
                  <?php echo $_GET['msg']; ?>. Please correct and try again.
              </div>


              <form action="admin/login_process.php" method="post" role="form" >
              <div class="row">
                <div class="mt-3 form-group">
                  <input type="text" name="user" class="form-control" id="user" placeholder="Your Email address" required>
                </div>
                <div class="mt-3 form-group">
                  <input type="password" name="pass" class="form-control" id="pass" placeholder="Your Password" required>
                </div>
              ...
              <div class="text-center startz"><button type="submit">Login >></button></div>
            </form>
            </div>
          </div>
