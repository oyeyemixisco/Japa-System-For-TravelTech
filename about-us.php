...
<head>
  ...
  <title>About Us | RelocateNow</title>
  ...
  <main id="main">
    ...
    <div class="breadcrumbs d-flex align-items-center" style="background-image: url('assets/img/aboutbg2.jpg');">
      <div class="container position-relative d-flex flex-column align-items-center">
        ...
        <h2>Europe is waiting for you...</h2>
        <ol>
          <li><a href="index.php">Home</a></li>
          <li>About Us</li>
        </ol>
        ...
        <div class="row gy-4" data-aos="fade-up">
          ...
          <div class="col-lg-8">
            <div class="content ps-lg-5">
              <h3>Opportunities are calling. Will you answer?</h3>
              <p>
                From openings in Information Technology, Finance, to Healthcare and hospitality, there are thousands of opportunities in Europe which you can take advantage of today and change your life. Europe is generally facing a dearth of skilled workforce in almost all sectors. <br><br>
                Most european countries have an aging population, and are looking to fill their shortage occupations from International applicants. From Germany to Austria, Luxembourg to Lithuania, the story is the same. Europe is open and hiring, and you can easily qualify to fill up this spaces.
              </p>
